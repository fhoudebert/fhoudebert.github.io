...
(function () {
  ...
  if (typeof WorkerGlobalScope === 'undefined' && typeof window === 'undefined') jsContext = "node";else if (typeof WorkerGlobalScope !== 'undefined' && self instanceof WorkerGlobalScope) jsContext = "worker";
  var gameClassCache = {};
  ...
  function BrowserCreateGame(gameName, options) {
    ...
    var promise = new Promise(function (resolve, reject) {
      exports.listGames().then(function (games) {
        ...
        window.BrowserScriptLoader["import"]("jocly.game.js").then(function (base) {
          var gamePromises = [window.BrowserScriptLoader["import"]("games/" + gameDescr.module + "/" + gameName + "-model.js"), window.BrowserScriptLoader["import"]("games/" + gameDescr.module + "/" + gameName + "-config.js")];
  ...
  exports.listGames = function () {
    var promise = new Promise(function (resolve, reject) {
      if (jsContext == "browser" || jsContext == "worker") window.BrowserScriptLoader["import"]("jocly-allgames.js").then(function (m) {
        var games = {};
  ...
  exports.getGameConfig = function (gameName) {
    var promise = new Promise(function (resolve, reject) {
      exports.listGames().then(function (games) {
        var gameDescr = games[gameName];
        if (!gameDescr) return reject(new Error("Game " + gameName + " not found"));
        if (typeof window != "undefined") window.BrowserScriptLoader["import"]("games/" + gameDescr.module + "/" + gameName + "-config.js").then(function (config) {
